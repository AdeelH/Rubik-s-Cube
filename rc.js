...
function makeCubes()
{
	...
	for (var i = 0; i < k*k*k; i++) 
	{
		...
		var textureCube = THREE.ImageUtils.loadTexture("img/wood.jpg");
...
//		var material = new THREE.MeshBasicMaterial( { map: textureCube, /*envMap:textureCube2,*/ color: 0xffffff, vertexColors: THREE.//FaceColors, shininess: 10, specular: 0x333333 } );
		var material = new THREE.MeshPhongMaterial( { map: textureCube, /*envMap:textureCube2,*/ color: 0xffffff, vertexColors: THREE.FaceColors, shininess: 100, specular: 0x333333 } );
